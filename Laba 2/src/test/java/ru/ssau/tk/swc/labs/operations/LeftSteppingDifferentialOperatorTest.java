...
class LeftSteppingDifferentialOperatorTest {
    ...
    void derive() {
        ...
        assertEquals(0.1714, newFunc.apply(10), 0.0001);
        assertEquals(0.1428571428571428, newFunc.apply(25));
        assertEquals(0.14285714285714324, newFunc.apply(90), 0.0001);
        assertEquals(0.14285714285714235, newFunc.apply(130));
        assertEquals(0.1428571428571388, newFunc.apply(999));
    }
}